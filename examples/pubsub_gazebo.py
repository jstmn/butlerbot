...
# from https://answers.gazebosim.org/question/25915/how-to-get-the-position-of-certain-object-in-gazebo-and-publish-it-on-a-topic-to-use-it-in-px4-or-ros/?answer=25934#post-id-25934
if __name__ == '__main__':
    ...
    def callback(data):
        ...
        for i in range(len(data.name)):
            ...
            print(i, transform.child_frame_id)
    ...
    # rospy.spin() # .spin() just sleeps. nothing special
    time.sleep(10)
    print("Done")