...
def update_collision_world(cw: CollisionWorld):
    if GAZEBO_MODE:
...
class HsrbRobot:
    ...
    def open_gripper(self):
        ...
        """
        # print("open_gripper() - Opening gripper", flush=True)
        self.gripper.command(1.2)

    def close_gripper(self):
        """See open_gripper() for details"""
        # print("close_gripper() - Closing gripper", flush=True)
        self.gripper.command(0.0)

    def move_to_neural(self) -> None:
        # print("move_to_neutral() - Moving to neutral pose", flush=True)
        self.whole_body.move_to_neutral()
